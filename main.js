...
const translations = {
    es: {
        ...
        'index.hero.title': 'Solidez en Exportación Agroindustrial',
        ...
        'index.hero.catalog': 'Ver Catálogo',
        ...
        'index.mod3.nopal': 'Nopal de Milpa Alta',
        ...
        'aguacate.logistics.airText': 'Máxima frescura para mercados gourmet. Entregas en menos de 48 horas en cualquier aeropuerto principal.',
        ...
        'nopal.hero.title': 'Nopal de Milpa Alta',
        ...
        'nopal.card3.tag': 'Transparencia',
        'nopal.card3.title': 'Proceso 100% Natural',
        'nopal.card3.text': 'Cultivado sin pesticidas químicos. Aunque no contamos con sellos internacionales oficiales, abrimos nuestras puertas para mostrar todo el proceso de cultivo y verificar su pureza natural.',
        ...
        'seg.escrow.text': 'Para erradicar cualquier riesgo de fraude en el sector agrícola, trabajamos bajo un sólido modelo de <strong>Fideicomiso de Garantía (Escrow) con Banorte</strong> como banco fiduciario. Esto protege al 100% los recursos de ambas partes.',
        'seg.escrow.i1': 'Fondos resguardados de forma segura en Banorte',
        'seg.escrow.i2': 'Liberación de fondos contra confirmación de entrega y calidad',
        'seg.escrow.i3': 'Cuentas corporativas fiduciarias plenamente verificadas en México',
    ...
    en: {
        ...
        'index.hero.title': 'Strength in Agroindustrial Export',
        ...
        'index.mod3.tagNatural': '100% NATURAL',
        'index.mod3.nopal': 'Nopal from Milpa Alta',
        ...
        'nopal.hero.title': 'Nopal from Milpa Alta',
        ...
        'nopal.card3.tag': 'Transparency',
        'nopal.card3.title': '100% Natural Process',
        'nopal.card3.text': 'Cultivated without chemical pesticides. Although we don\'t hold official international seals, we open our doors to show the entire cultivation process and verify its natural purity.',
        ...
        'seg.escrow.text': 'To eradicate any risk of fraud in the agricultural sector, we work under a solid <strong>Escrow Guarantee Trust with Banorte</strong> as fiduciary bank. This 100% protects the resources of both parties.',
        'seg.escrow.i1': 'Funds safely held at Banorte',
        'seg.escrow.i2': 'Release of funds upon confirmation of delivery and quality',
        'seg.escrow.i3': 'Fully verified fiduciary corporate accounts in Mexico',
