...
const translations = {
    es: {
        ...
        'index.hero.escrow': 'Compra Segura',
        ...
        'nopal.card1.text': 'Cada pieza es seleccionada a mano por expertos productores de Milpa Alta, asegurando un color verde vibrante y el tamaño ideal para el mercado nacional.',
        ...
        'nopal.card3.text': 'Certificados ante el SENASICA (Servicio Nacional de Sanidad, Inocuidad y Calidad Agrícola). Producto libre de agroquímicos, cultivado con abonos orgánicos naturales y preparaciones sin químicos.',
        'nopal.specs.title': 'Datos Técnicos del Producto',
        'nopal.specs.sizeTitle': 'Tamaño Comercial',
        'nopal.specs.sizeText': 'Diferentes calibres disponibles',
        ...
        'seg.escrow.title': 'Esquema de Fideicomiso (Escrow) Bancario',
        'seg.escrow.text': 'Para erradicar cualquier riesgo de fraude en el sector agrícola, trabajamos bajo un sólido modelo de <strong>Fideicomiso de Garantía (Escrow)</strong> como figura neutral. Los fondos son custodiados y liberados únicamente cuando se cumplen las condiciones del contrato.',
        'seg.escrow.stepsTitle': '¿Cómo funciona el fideicomiso?',
        'seg.escrow.step1Title': 'El comprador deposita los fondos',
        'seg.escrow.step1Text': 'El comprador deposita el importe total de la orden de compra al fideicomiso bancario, quien custodia los fondos hasta que se cumplan las condiciones del contrato de compra-venta.',
        ...
        'seg.escrow.i1': '<i class="fas fa-check-circle"></i> Seguridad jurídica: El banco actúa como tercero neutral e imparcial',
        ...
        'seg.process.s2Text': 'Formalización legal y apertura de la cuenta Escrow fiduciaria.',
        ...
        'nos.contact.address': 'Río Misisipi 49, Piso 14, Interior 1402, Colonia Cuauhtémoc, Alcaldía Cuauhtémoc, Ciudad de México, C.P. 06500.',
    ...
    en: {
        ...
        'index.hero.escrow': 'Secure Purchase',
        ...
        'nopal.card1.text': 'Each piece is hand-selected by expert producers from Milpa Alta, ensuring a vibrant green color and the ideal size for the national market.',
        ...
        'nopal.card3.text': 'Certified by SENASICA (Mexico\'s National Agricultural Health, Safety and Quality Service). Product free of agrochemicals, grown with natural organic fertilizers and chemical-free pest control.',
        'nopal.specs.title': 'Product Technical Data',
        'nopal.specs.sizeTitle': 'Commercial Size',
        'nopal.specs.sizeText': 'Different sizes available',
        ...
        'seg.escrow.title': 'Banking Escrow Trust Scheme',
        'seg.escrow.text': 'To eradicate any risk of fraud in the agricultural sector, we operate under a solid <strong>Escrow Guarantee Trust</strong> as a neutral fiduciary figure. Funds are safeguarded and released only when contract conditions are met.',
        'seg.escrow.stepsTitle': 'How does the escrow trust work?',
        'seg.escrow.step1Title': 'Buyer deposits the funds',
        'seg.escrow.step1Text': 'The buyer deposits the full purchase order amount into the fiduciary account, which holds the funds until the conditions of the purchase agreement are fulfilled.',
        ...
        'seg.escrow.i1': '<i class="fas fa-check-circle"></i> Legal security: The bank acts as a neutral, impartial third party',
        ...
        'seg.process.s2Text': 'Legal formalization and opening of the Escrow fiduciary account.',
        ...
        'nos.contact.text': 'We are ready to size your export requirement. Complete the form and a commercial specialist will contact you in less than 24 hours.',
        'nos.contact.address': 'Rio Misisipi 49, Floor 14, Apt 1402, Colonia Cuauhtemoc, Mexico City, 06500.',
