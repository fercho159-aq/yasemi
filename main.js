...
const translations = {
    es: {
        ...
        'seg.escrow.i1': '<i class="fas fa-check-circle"></i> Seguridad jurídica: El fideicomiso actúa como tercero neutral e imparcial',
    ...
    en: {
        ...
        'seg.escrow.i1': '<i class="fas fa-check-circle"></i> Legal security: The trust acts as a neutral, impartial third party',
